...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTG = _reactAddonsCssTransitionGroup2.default;
	...
	var Main = function (_React$Component) {
	  ...
	  function Main(props) {
	    ...
	    _this.handleRemount = _this.handleRemount.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Main, [{
	    ...
	    key: 'handleRemount',
	    value: function handleRemount(e) {
	      this.setState({
	        isVisible: true
	      }, function () {
	        console.log(this.state.isVisible);
	    ...
	    value: function render() {
	      ...
	      var component = this.state.isVisible ? _react2.default.createElement(Modal, { onSubmit: this.handleSubmit, key: 'modal' }) : _react2.default.createElement(ModalBack, { onClick: this.handleRemount, key: 'bringitback' });
	...
	var ModalBack = function (_React$Component5) {
	  _inherits(ModalBack, _React$Component5);

	  function ModalBack() {
	    _classCallCheck(this, ModalBack);

	    return _possibleConstructorReturn(this, (ModalBack.__proto__ || Object.getPrototypeOf(ModalBack)).apply(this, arguments));
	  }

	  _createClass(ModalBack, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'button',
	        { className: 'bringitback', onClick: this.props.onClick, key: this.props.className },
